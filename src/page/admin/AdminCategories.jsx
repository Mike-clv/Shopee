      ...
      <div className="mb-5 flex flex-col gap-3 sm:mb-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-7 text-muted-foreground">
            Sắp xếp danh mục, chỉnh icon và quản lý trạng thái hiển thị để nhìn rõ hơn trên cả desktop lẫn mobile.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span className={`rounded-full px-2.5 py-1 ${getStatusBadgeClass(category.is_active)}`}>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-secondary/50">
                ...
                <th className="hidden p-3 text-center font-medium lg:table-cell">Trạng thái</th>
              ...
              {categories.map((category) => (
                <tr key={category.id} className="border-b hover:bg-secondary/30">
                  ...
                  <td className="hidden p-3 text-center lg:table-cell">
                    <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-medium ${getStatusBadgeClass(category.is_active)}`}>
                      {category.is_active ? 'Đang hiện' : 'Đang ẩn'}
                    </span>
                  </td>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="VD: Shirt, Smartphone, Heart"
                />
              </div>
